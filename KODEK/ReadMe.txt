...
The application wizard has created this KODEK application for
you.  This application not only demonstrates the basics of using the Microsoft
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your KODEK application.
...
res\KODEK.ico
    ...
    icon is included by the main resource file KODEK.rc.
...
KODEKDlg.h, KODEKDlg.cpp - the dialog
    These files contain your CKODEKDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's template is
    in KODEK.rc, which can be edited in Microsoft Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CKODEKDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named KODEK.pch and a precompiled types file named StdAfx.obj.
